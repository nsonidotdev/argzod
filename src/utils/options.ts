...
export const matchOptionDefinitionByParsedOption = <T extends string>(option: ParsedOption, definitions: CommandOptions): [T, OptionDefinition] | undefined => {
...
export const matchParsedOptionsByDefinition = ([defKey, definition]: [string, OptionDefinition], parsedOptions: ParsedOption[]): ParsedOption[] => {
